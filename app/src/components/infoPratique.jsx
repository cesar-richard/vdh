    ...
    >
      ...
      <Container fluid>
        <div className="row">
          ...
          <div className="col-xs-12 col-sm-6 col-md-3 count my-5">
            <div className="count-item mb-sm-40">
              <div className="count-icon">
                <i className="fa fa-flag-checkered fa-5x" />
              </div>
              <h3>Départs</h3>
              <h5 className="count-title font-serif">
                Marche : 14h30
          ...
          <div className="col-xs-12 col-sm-6 col-md-3 count my-5">
            <i className="fa fa-cutlery fa-5x" />
            <h3>Dégustation</h3>
            <h5 className="count-title font-serif">
